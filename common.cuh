...
// M_PI is not guaranteed by the C standard -- define it if missing
#ifndef M_PI
...
__device__ __forceinline__ void atomicMinFloat(float *__restrict__ addr, float val)
{
...
__host__ __device__ __forceinline__
    T
    clampVal(T x, T lo, T hi) { return (x < lo) ? lo : (x > hi) ? hi
                                                                : x; }
